...
function openWhatsApp(customMessage) {
    const message = customMessage || `Hello Creative Events by Apollo,

I would like to know more about your event management services.
...
function enquirePortfolio(categoryName) {
    const message = `Hello Creative Events by Apollo,

I am interested in your ${categoryName} setup.

Please share more details.`;

    openWhatsApp(message);
}
window.enquirePortfolio = enquirePortfolio;
...
window.enquireService = enquireService;
...
window.planMyEvent = planMyEvent;
